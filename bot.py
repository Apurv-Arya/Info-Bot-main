...
• Forward a Message To Get its Details (in Private)
• Send any Media To Get its Details (in private)
• Reply /info to a Message To Get Message Details
• Use /info Command To Get your Details
• Use /id in Group or Channel to get Unique Telegram Channel ID"""

ABOUT_TEXT = """--**About Me**--

- **Bot :** `Info Bot`
- **Creator :** [TBots_Father](https://telegram.me/TBots_Father)
...
print("Bot Started!!! Now Join on @TBots_Father")
Bot.run()
